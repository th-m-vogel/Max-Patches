...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.394734263420105, 716.0, 68.0, 20.0 ],
					"text" : "s ---g_rest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 776.815785050392151, 848.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 416.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 296.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 290.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 596.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 650.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "r ---M4L_active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.394734263420105, 223.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "s ---M4L_active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.315785050392151, 0.02631688117981, 525.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 811.815785050392151, 894.0, 59.09648923079169, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 735.815785050392151, 894.0, 59.09648923079169, 48.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "jit.phys.world @name ---BouncyDrumpadsPhys @drawto ---_BouncyDrumpads @worldbox_scale 40. 200. 40. @gravity 0. -1. 0. @collisions 1 @enable 1 @worldbox 1 @numthreads 4"
								}
...
,
					"patching_rect" : [ 85.0, 716.0, 111.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "jit.world ---_BouncyDrumpads @fsaa 1 @fps 30 @size 400 270 @dim 400 270 @output_texture 1 @fsmenubar 0 @enable 1"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 296.0, 446.0, 41.0, 48.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "sendbody 1 0 impulse 0. 2.25 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 269.0, 422.0, 29.5, 22.0 ],
									"text" : "+ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 269.0, 398.0, 29.5, 22.0 ],
									"text" : "/ 4."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 430.0, 285.0, 92.0, 22.0 ],
									"text" : "s ---Flash_Pad"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 525.0, 477.0, 29.5, 22.0 ],
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 525.0, 596.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 353.5, 388.0, 278.5, 388.0 ],
									"order" : 1,
									"source" : [ "obj-80", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 353.5, 403.0, 534.5, 403.0 ],
									"order" : 0,
									"source" : [ "obj-80", 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.camera ---_BouncyDrumpads @tripod 1 @locklook 1 @position 0. 5. -28."
								}
...
,
					"patching_rect" : [ 296.0, 377.0, 109.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.pass ---_BouncyDrumpads @fxname bloom-hq @threshold 1.2 @gamma 0.5 @quality hi @bloom_amt 0.8 @upsample_scale 1."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.material ---_BouncyDrumpads @shininess 0. @diffuse_model toon @specular_size 0.193 @override 1 @diffuse_size 0.705 @mat_diffuse 1. 1. 1. 1. @specular_model toon @specular_smooth 0.11 @gl_color 1. 1. 1. 1. @diffuse_smooth 0.127 @mat_specular 1. 1. 1. 1. @mat_emission 1. 1. 1. 1. @mat_ambient 1. 1. 1. 1. @fog none"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.gridshape ---_BouncyDrumpads @name ---OrbitterLight @scale 0.1 0.1 0.1 @position 0. 0. 25. @color 1.5 1.5 1.5 1. @mat_diffuse 1. 1. 1. 0.25 @gl_color 1. 1. 1. 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.light ---_BouncyDrumpads @name ---Orbitter @direction 0. 0. 0. @diffuse 0.25 0.25 0.25 1. @position 0. 5. -20. @type point @shadows 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.light ---_BouncyDrumpads @name ---Spot2 @direction 1. -1. 1. @diffuse 0.4 0.4 0.4 1. @type point @shadows 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.light ---_BouncyDrumpads @name ---Spot1 @direction -1. -1. -1. @diffuse 0.7 0.7 0.7 1. @type point @shadows 1"
								}
...
,
					"patching_rect" : [ 296.0, 508.0, 111.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 632.815785050392151, 144.52631688117981, 22.105263948440552, 144.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 666.815785050392151, 268.52631688117981, 68.0, 20.0 ],
					"text" : "s ---to_world"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 666.815785050392151, 179.02631688117981, 104.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 708.811174869537354, 47.439631581306458, 78.0, 78.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.394734263420105, 114.0, 99.5, 25.0 ],
					"text" : "InitBang",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 651.0, 47.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 121.0, 637.0, 45.894734263420105, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 177.0, 636.0, 41.0, 48.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.model ---_BouncyDrumpads @file Pad-Fillet.obj @lighting_enable 1 @shadow_caster 1 @scale 5.5 4. 5.5 @position 0. -7.26 0. @smooth_shading 1 @auto_material 0 @material_mode 0 @fog 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.model ---_BouncyDrumpads @file Pad-Fillet.obj @position 0. 0.4 0."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.material ---_BouncyDrumpads @specular_model ward @gl_color 0. 0. 0. 1. @mat_ambient 0.827451 0.827451 0.827451 1. @shininess 55. @override 1 @mat_diffuse 1. 1. 1. 1. @diffuse_model lambert @mat_specular 1. 1. 1. 1. @fog none"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.gridshape ---_BouncyDrumpads @lighting_enable 1 @shape sphere @smooth_shading 1 @automatic 0 @shadow_caster 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.multiple ---_BouncyDrumpads 3 @glparams position color scale"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.multiple ---_BouncyDrumpads 2 @glparams position color"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 242.0, 180.0, 593.0, 36.0 ],
									"text" : "jit.gl.material ---_BouncyDrumpads @mat_specular 0.5 0.5 0.5 1. @gl_color 0. 0. 0. 1. @mat_ambient 0. 0. 0. 1. @shininess 21 @override 1 @mat_diffuse 0. 0. 0. 1. @specular_model ward @fog none"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jit.gl.material ---_BouncyDrumpads @mat_specular 1. 1. 1. 1. @gl_color 0.861646 0.166537 0. 1. @mat_ambient 0. 0. 0. 0.968627 @shininess 15. @override 1 @mat_diffuse 0. 0. 0. 1. @specular_model ward @darkness 1. @specular_smooth 0.11 @diffuse_smooth 0.127 @roughness 0.99 @specular_size 0.193 @diffuse_size 0.705 @fog none"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-47", 2 ],
									"midpoints" : [ 1037.5, 423.0, 769.5, 423.0 ],
									"order" : 1,
									"source" : [ "obj-3", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.394734263420105, 254.0, 85.0, 20.0 ],
					"style" : "chiba",
					"text" : "s ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.394734263420105, 221.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 272.394734263420105, 181.0, 89.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 241.394734263420105, 152.0, 100.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 451.0, 121.0, 25.0 ],
					"text" : "Light & Effects",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 686.815785050392151, 1007.0, 213.0, 20.0 ],
					"text" : "noteout 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 686.815785050392151, 974.0, 116.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 281.894734263420105, 212.532898962497711, 250.894734263420105, 212.532898962497711 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-92", 0 ],
					"midpoints" : [ 330.5, 690.0, 250.894734263420105, 690.0 ],
					"order" : 1,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 130.5, 624.0, 183.0, 624.0, 183.0, 630.0, 186.5, 630.0 ],
					"order" : 0,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 26.5, 703.0, 94.5, 703.0 ],
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 821.315785050392151, 959.823497235774994, 793.315785050392151, 959.823497235774994 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 130.5, 703.0, 94.5, 703.0 ],
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-70", 0 ],
					"midpoints" : [ 786.315785050392151, 879.0, 745.315785050392151, 879.0 ],
					"order" : 1,
					"source" : [ "obj-91", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-76", 0 ],
					"midpoints" : [ 786.315785050392151, 879.0, 821.315785050392151, 879.0 ],
					"order" : 0,
					"source" : [ "obj-91", 0 ]
				}
